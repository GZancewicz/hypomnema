...
def fetch_chapter(book_abbr, chapter, retries=3):
...
def main():
    ...
    for folder_name, book_abbr, num_chapters in books:
        ...
        if not missing_chapters:
            print(f"  {folder_name} is complete!")
            continue
        ...
        for chapter_num in missing_chapters:
            ...
            if verses:
                ...
                if chapter_text:
                    ...
                    print(f"    Successfully saved chapter {chapter_num}")
            
            # Be respectful to the API
            time.sleep(2)  # Increased delay
        
        # Rebuild full book file
        print(f"  Rebuilding {folder_name}.txt...")
        full_book_text = ""
        
        for chapter_num in range(1, num_chapters + 1):
            chapter_file = os.path.join(book_path, f"chapter-{chapter_num}", "chapter.txt")
