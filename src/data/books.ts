...
export const books: Book[] = [
  ...
  { name: 'Esther', chapters: 16, testament: 'OT' },
  ...
  { name: 'Tobit', chapters: 14, testament: 'OT', isDeuterocanonical: true },
  { name: 'Judith', chapters: 16, testament: 'OT', isDeuterocanonical: true },
  { name: 'Wisdom of Solomon', chapters: 19, testament: 'OT', isDeuterocanonical: true },
  { name: 'Sirach', chapters: 51, testament: 'OT', isDeuterocanonical: true },
  { name: 'Baruch', chapters: 6, testament: 'OT', isDeuterocanonical: true },
  { name: '1 Maccabees', chapters: 16, testament: 'OT', isDeuterocanonical: true },
  { name: '2 Maccabees', chapters: 15, testament: 'OT', isDeuterocanonical: true },
